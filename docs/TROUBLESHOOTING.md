...
**Packaging fails with "ERROR: Can't allocate required memory!"**

The build log shows this shortly after `7-Zip (a) 24.09 (x86)`:

```
Add new data to archive: 16 folders, 391 files, 852798390 bytes (814 MiB)
